...
def main(args):
    ...
    if os.path.exists("vision_transformer/weights") is False:
        os.makedirs("vision_transformer/weights")
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(
            model.state_dict(), "vision_transformer/weights/model-{}.pth".format(epoch)
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default="vision_transformer/vit_base_patch32_224_in21k.pth",
