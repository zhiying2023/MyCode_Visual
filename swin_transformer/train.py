...
def main(args):
    ...
    if os.path.exists("swin_transformer/weights") is False:
        os.makedirs("swin_transformer/weights")
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(
            model.state_dict(), "swin_transformer/weights/model-{}.pth".format(epoch)
        )
